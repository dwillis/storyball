...
Step 6: Save your text file as whatever you want to name it DOT csv and put it in this directory.

![](images/csv6.png){width="100%"}

Step 7: Import your data using the tidyverse. You just created a CSV file.
