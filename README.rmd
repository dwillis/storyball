...
[First, to make this work, follow the installation instructions](https://cfbfastr.sportsdataverse.org/) and then follow how to get an API key from College Football Data. Replace YOUR-API-KEY-HERE with your key.
